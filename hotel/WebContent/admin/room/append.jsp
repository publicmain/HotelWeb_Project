    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/room/append" method="post"">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="roomnum" name="roomnum"  class="form-control" id="fname" placeholder="请输入用 户名称">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="region" name="region"  class="form-control" id="email1" placeholder="请输入酒店id">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="cono1" class="col-sm-3 text-right control-label col-form-label">门码锁</label>
                                    <div class="col-sm-5">
                                        <input type="text" id="locknumber" name="locknumber"  class="form-control" id="cono1" placeholder="请输入密保提示">
                                    </div>
                                </div>

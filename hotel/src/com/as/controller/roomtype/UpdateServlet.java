...
public class UpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            {
            	//取图片的旧值
            	filename=request.getParameter("picture");
            }
		...
		RoomType roomType=new RoomType(id, "", hotelid, roomtypename, bedsnumber, dayprice, hourprice, depositmoney, picture, total, note);
		RoomTypeService roomTypeService=new RoomTypeServiceImpl();
		//调用方法 修改
		roomTypeService.modifyById(roomType);
		//重定向
